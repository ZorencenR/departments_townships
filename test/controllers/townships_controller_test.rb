...
class TownshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create township" do
    assert_difference('Township.count') do
      post townships_url, params: { township: { department_id: @township.department_id, name: @township.name } }
    end
  ...
  test "should update township" do
    patch township_url(@township), params: { township: { department_id: @township.department_id, name: @township.name } }
